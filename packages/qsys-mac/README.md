...
[`qsys-mac-installer 0.1.8`](https://github.com/reowens/qsys-tools/releases/tag/qsys-mac-installer-v0.1.8)
...
```text
~/Library/Caches/qsys-mac/qsys-mac-installer-0.1.8.dmg
```
